...
class PartnershipButton(discord.ui.Button):
    def __init__(self):
        super().__init__(label='No-ping Partnership', style=discord.ButtonStyle.grey, custom_id='npartner', emoji="🤝")
