...
class OnMemberJoin(commands.Cog): 
  ...
  async def on_member_join(self, member):
    ### ------ GENSHIN IMPACT CAFE ------ ###
    btn = ["Greet our new traveler", "Say hi to user", "Welcome our new traveler", "Show some support to our new traveler"]
    emote = ["👋", "💖", "❤️", "💛", "💜", "💙"]
    if member.guild.id == 717029019270381578:
      channel = self.client.get_channel(968751043884224532)
      member_count = 0;
  ...
  To make sure you won't accidentally get too close to the Sun, please read <#754575055098347604> before doing anything!
  
  Ay, what are you waiting for? Let's go and start saying hi <#968751043884224532>!
  
  Oh yeah, and btw, PAIMON IS NOT EMERGENCY FOOD! <:Paimon_Think:944862982213632101>
  """, color=0xFECEF8)
      embed.set_thumbnail(url="https://progameguides.com/wp-content/uploads/2022/01/Featured-Paimon-Genshin-Impact.jpg")
    ...
    ### ------ GENSHIN HANGOUT ------ ###
      ...
      embed = discord.Embed(title="Traveler! Traveler! where are you?", description="""
  ...
  """, color=0x5ADCAE)
      ...
      url = msg.attachments[0].proxy_url 
      embed.set_image(url=url)
      embed.set_thumbnail(url="https://media.discordapp.net/attachments/717216024910364732/955679237547909210/genshin-impact-all-characters.jpg")
