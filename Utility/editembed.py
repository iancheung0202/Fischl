...
class modal(discord.ui.Modal, title = "Edit Embed Message"):
  
  msgid = discord.ui.TextInput(label="Message ID", style=discord.TextStyle.paragraph, placeholder="Enter the 19-digit message ID", max_length=19, required=False)
  ...
  async def on_submit(self, interaction:discord.Interaction):
    ...
    embed = discord.Embed(title="", description=f'**Custom embed message edited**', colour=0x00FF00)
